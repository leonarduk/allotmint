...
import { getOwners, getUserConfig, updateUserConfig } from "../api";
import type { OwnerSummary, UserConfig } from "../types";
        ...
        <form onSubmit={save} className="space-y-2">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setCfg({ ...cfg, hold_days_min: e.target.value ? Number(e.target.value) : undefined })
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setCfg({
                  ...cfg,
                  max_trades_per_month: e.target.value ? Number(e.target.value) : undefined,
                })
              }
            />
          </div>
