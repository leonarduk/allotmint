...
class TestExtractIssueBody:
    @mock.patch("pr_review.get_repo_info")
    @mock.patch("subprocess.run")
    def test_extract_closes_reference(self, mock_run, mock_get_repo):
    ...
    def test_no_issue_reference(self):
        ...
        body = extract_issue_body(pr_body)
        assert body == pr_body

    @mock.patch("pr_review.get_repo_info")
    @mock.patch("pr_review.subprocess.run")
    def test_issue_fetch_failure(self, mock_run, mock_get_repo):
