...
def test_portfolio_section_builders(monkeypatch):
    ...
    # build_owner_portfolio must be called exactly once across all five sections
    assert call_count["n"] == 1, f"Expected 1 call to build_owner_portfolio, got {call_count['n']}"
