...
def _build_portfolio_var_section(
    ...
    the portfolio loaded successfully. Returns [] when risk is unavailable.
    Cash is excluded from VaR computation (include_cash=False) to match the
    original audit-report behaviour.
    """
    if risk is None:
        return []
