...
from stacks.exports import (
    UI_AUTH_DOMAIN_EXPORT,
    UI_AUTH_USER_POOL_CLIENT_ID_EXPORT,
    UI_AUTH_USER_POOL_ID_EXPORT,
)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        ui_auth_pool.add_domain(
            "UiAuthDomain",
            cognito_domain=cognito.CognitoDomainOptions(domain_prefix=ui_auth_domain_prefix),
        )
        ...
        CfnOutput(
            self,
            "UiAuthUserPoolId",
            value=ui_auth_pool.user_pool_id,
            export_name=UI_AUTH_USER_POOL_ID_EXPORT,
        )
        CfnOutput(
            self,
            "UiAuthUserPoolClientId",
            value=ui_auth_client.user_pool_client_id,
            export_name=UI_AUTH_USER_POOL_CLIENT_ID_EXPORT,
        )
        CfnOutput(self, "UiAuthDomain", value=ui_auth_domain, export_name=UI_AUTH_DOMAIN_EXPORT)
