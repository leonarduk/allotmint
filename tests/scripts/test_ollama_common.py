...
class TestGetOllamaModel:
    def test_default_model(self):
        """Should return default qwen2.5-coder:7b when env var not set."""
        with mock.patch.dict(os.environ, {}, clear=True):
            assert get_ollama_model() == "qwen2.5-coder:7b"
...
class TestListAvailableModels:
    ...
    def test_successful_model_list(self, mock_urlopen):
        ...
        response_data = {"models": [{"name": "qwen2.5-coder:7b"}, {"name": "mistral"}, {"name": "codellama"}]}
        ...
        assert models == ["qwen2.5-coder:7b", "mistral", "codellama"]
...
class TestValidateOllamaConnection:
    ...
    def test_valid_connection(self, mock_list_models):
        ...
        mock_list_models.return_value = ["qwen2.5-coder:7b", "mistral"]
...
class TestFetchOllamaReview:
    ...
    def test_successful_review(self, mock_urlopen):
        ...
        review = fetch_ollama_review("http://localhost:11434", "qwen2.5-coder:7b", "Test prompt")
